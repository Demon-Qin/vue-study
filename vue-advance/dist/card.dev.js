...
var app = new Vue({
  ...
  data: {
    ...
    students: [{
      ...
      "avatar": "https://flobby.oss-cn-shenzhen.aliyuncs.com/avatar/4a3935d6-9579-467f-b63d4a956414306f.jpg",
  ...
  methods: {
    change() {
      this.color = "#333",
      this.backgroundcolor = "#fcbad3"
          },
    change1() {
      this.color = "#fff",
      this.backgroundcolor = "#aa96da"
          },      
    },
});